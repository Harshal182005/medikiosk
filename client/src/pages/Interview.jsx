...
function Interview() {
    ...
    const getNextQuestion = async (currentAnswers = []) => {
        try {
            setLoading(true);
            setMessage("");
        ...
        return (
            <div className="interview-page">
                ...
                <main className="completion-container">
                    ...
                    <div className="completion-card">
                        ...
                        <p className="completion-description">
                            ...
                            securely recorded and is ready for
                            the next step.
                        </p>
                        ...
                        <div className="documents-prompt">
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    reports or other medical
                                    documents. MediKiosk can
                                    extract and organize their
                                    information.
                                </p>
                            </div>
                ...
                <footer className="interview-footer">
                    AI-generated information is intended
                    for doctor review.
                </footer>
            ...
            <style>{`
                ...
                * {
                ...
                .mic-waves i {
                    ...
                    background: white;
                    border-radius: 3px;
                    animation: voiceWave 0.7s infinite
                        alternate;
                }
